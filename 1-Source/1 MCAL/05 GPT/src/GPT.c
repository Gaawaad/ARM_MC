...
volatile u32 *GPTMCTL_Reg_Arr[] = {&GPTMCTL_0A_Reg, &GPTMCTL_1A_Reg, &GPTMCTL_2A_Reg, &GPTMCTL_3A_Reg, &GPTMCTL_4A_Reg, &GPTMCTL_5A_Reg};
volatile u32 *GPTMTAMR_Reg_Arr[] = {&GPTMTAMR_0A_Reg, &GPTMTAMR_1A_Reg, &GPTMTAMR_2A_Reg, &GPTMTAMR_3A_Reg, &GPTMTAMR_4A_Reg, &GPTMTAMR_5A_Reg};
volatile u32 *GPTMTAILR_Reg_Arr[] = {&GPTMTAILR_0A_Reg, &GPTMTAILR_1A_Reg, &GPTMTAILR_2A_Reg, &GPTMTAILR_3A_Reg, &GPTMTAILR_4A_Reg, &GPTMTAILR_5A_Reg};
volatile u32 *GPTMCFG_Reg_Arr[] = {&GPTMCFG_0A_Reg, &GPTMCFG_1A_Reg, &GPTMCFG_2A_Reg, &GPTMCFG_3A_Reg, &GPTMCFG_4A_Reg, &GPTMCFG_5A_Reg};
volatile u32 *GPTMIMR_Reg_Arr[] = {&GPTMIMR_0A_Reg, &GPTMIMR_1A_Reg, &GPTMIMR_2A_Reg, &GPTMIMR_3A_Reg, &GPTMIMR_4A_Reg, &GPTMIMR_5A_Reg};
volatile u32 *GPTMICR_Reg_Arr[] = {
    &GPTMICR_0A_Reg,
    &GPTMICR_1A_Reg,
    &GPTMICR_2A_Reg,
    &GPTMICR_3A_Reg,
...
void Gpt_Init(GPTChannelId_t GptChannelId, void (*GptNotification)(void))
{
    ...
    *GPTMTAMR_Reg_Arr[GptChannelId] |= GptChannelCfg_Arr[GptChannelId].ChannelMode;
...
void GPT_StartTimer(GPTChannelId_t GptChannelId)
{
    ...
    *GPTMTAILR_Reg_Arr[GPT_PREDF] = 1600;
#else
    *GPTMTAILR_Reg_Arr[GptChannelId] = GptChannelCfg_Arr[GptChannelId].GptChannelTickMaxValue;
    *GPTMCTL_Reg_Arr[GptChannelId] |= (1 << 0);
#endif
}
